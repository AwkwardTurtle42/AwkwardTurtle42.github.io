...
However stat blocks from Into the Odd, Cairn, or similar games can be used nearly as written. Abilities from 0-8 are a d4, 8-10 a d6, 11-14 a d8,
15-18 a d10, and 18+ a d12.
...
In play, developing new spells or rituals should be time consuming, require strange ingredients or unique environments, and probably carry an element of risk. Each spell and ritual is unique (which is not to say two
wizards couldn’t develop similar spells independently) which means something special must occur to spark new magic to life.
