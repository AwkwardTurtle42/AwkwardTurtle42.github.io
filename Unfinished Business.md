 ...
 * Drags captured targets to the [Hiring Pool](#3-hiring-pool).
...
5. Re-Org! Each player is randomly assigned a character as their manager. All actions require explicit managerial permission.
